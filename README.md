...
📚 What I Learned:
How to design effective prompts for AI systems (Prompt Engineering)
Generating complete websites without manual coding
Understanding UI/UX principles for educational platforms
Practical application of Generative AI in real-world scenarios
🎓 Institution: Superior University
👩‍🏫 Instructor: Aleena Aslam
This project shows how AI can simplify and accelerate web development while maintaining professional quality.
